...
class LeapHandOver(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        asset_root = "../assets"
        allegro_hand_asset_file = "urdf/leap_hands_sensors/urdf/leap_hands_sensors.urdf"
        allegro_hand_another_asset_file = "urdf/leap_hands_sensors/urdf/leap_hands_sensors.urdf"
        ...
        self.goal_displacement = gymapi.Vec3(0., -0.08, 0)
